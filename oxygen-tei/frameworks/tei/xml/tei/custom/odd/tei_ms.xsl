...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <!--PATTERN tei_ms-att.datable-calendar-constraint-calendar-1-->
...
belongs, but this <xsl:text/>
   ...
   <!--PATTERN tei_ms-att.typed-constraint-subtypeTyped-2-->
 ...
 unless also categorized in general with @type (@type)</xsl:message>
   ...
   <!--PATTERN tei_ms-att.pointing-targetLang-constraint-targetLang-3-->
   ...
   <!--PATTERN tei_ms-att.spanning-spanTo-constraint-spanTo-2-4-->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN tei_ms-att.styleDef-schemeVersion-constraint-schemeVersionRequiresScheme-5-->
   ...
   <!--PATTERN tei_ms-ptr-constraint-ptrAtts-6-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN tei_ms-ref-constraint-refAtts-7-->
   ...
   <!--PATTERN tei_ms-list-constraint-gloss-list-must-have-labels-8-->
   ...
   <!--PATTERN tei_ms-biblStruct-constraint-deprecate-altIdentifier-child-9-->
   ...
   <!--PATTERN tei_ms-relatedItem-constraint-targetorcontent1-10-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN tei_ms-lg-constraint-atleast1oflggapl-11-->
   ...
   <!--PATTERN tei_ms-quotation-constraint-quotationContents-12-->
...
On <xsl:text/>
   ...
   <!--PATTERN tei_ms-link-constraint-linkTargets3-13-->
   ...
   <!--PATTERN tei_ms-join-constraint-joinTargets3-14-->
...
You must supply at least two values for @target on <xsl:text/>
   ...
   <!--PATTERN tei_ms-relation-constraint-reforkeyorname-17-->
   ...
   <!--PATTERN tei_ms-relation-constraint-activemutual-18-->
...
@active and @mutual may be supplied (@active and @mutual)</xsl:message>
   ...
   <!--PATTERN tei_ms-relation-constraint-activepassive-19-->
   ...
   <!--PATTERN tei_ms-addSpan-constraint-spanTo-20-->
   ...
   <!--PATTERN tei_ms-damageSpan-constraint-spanTo-22-->
...
The @spanTo attribute of <xsl:text/>
   ...
   <!--PATTERN tei_ms-delSpan-constraint-spanTo-24-->
   ...
   <!--PATTERN tei_ms-subst-constraint-substContents1-26-->
   ...
   <!--PATTERN tei_ms-dimensions-constraint-duplicateDim-27-->
...
The element <xsl:text/>
   ...
   <!--PATTERN tei_ms-msIdentifier-constraint-msId_minimal-28-->


	  <!--RULE -->
   <xsl:template match="tei:msIdentifier" priority="1000" mode="M28">
   ...
   <!--PATTERN tei_ms-msPart-constraint-deprecate-altIdentifier-child-29-->


	  <!--RULE -->
   <xsl:template match="tei:msPart" priority="1000" mode="M29">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:teiHeader" priority="1000" mode="M30">
