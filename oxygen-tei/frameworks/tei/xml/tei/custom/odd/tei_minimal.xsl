...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <!--PATTERN tei_minimal-att.datable-calendar-constraint-calendar-1-->
...
belongs, but this <xsl:text/>
   ...
   <!--PATTERN tei_minimal-att.typed-constraint-subtypeTyped-2-->
 ...
 unless also categorized in general with @type (@type)</xsl:message>
   ...
   <!--PATTERN tei_minimal-att.pointing-targetLang-constraint-targetLang-3-->
   ...
   <!--PATTERN tei_minimal-att.spanning-spanTo-constraint-spanTo-2-4-->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN tei_minimal-att.styleDef-schemeVersion-constraint-schemeVersionRequiresScheme-5-->
   ...
   <!--PATTERN tei_minimal-ptr-constraint-ptrAtts-6-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN tei_minimal-ref-constraint-refAtts-7-->
   ...
   <!--PATTERN tei_minimal-list-constraint-gloss-list-must-have-labels-8-->
   ...
   <!--PATTERN tei_minimal-biblStruct-constraint-deprecate-altIdentifier-child-9-->


	  <!--RULE -->
   <xsl:template match="tei:biblStruct" priority="1000" mode="M13">
   ...
   <!--PATTERN tei_minimal-relatedItem-constraint-targetorcontent1-10-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN tei_minimal-lg-constraint-atleast1oflggapl-11-->


	  <!--RULE -->
   <xsl:template match="tei:lg" priority="1000" mode="M15">
   ...
   <!--PATTERN tei_minimal-quotation-constraint-quotationContents-12-->


	  <!--RULE -->
   <xsl:template match="tei:quotation" priority="1000" mode="M16">
...
On <xsl:text/>
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:teiHeader" priority="1000" mode="M17">
