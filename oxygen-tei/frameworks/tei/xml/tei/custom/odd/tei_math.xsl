...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <!--PATTERN tei_math-att.datable-calendar-constraint-calendar-1-->
...
belongs, but this <xsl:text/>
   ...
   <!--PATTERN tei_math-att.typed-constraint-subtypeTyped-2-->
 ...
 unless also categorized in general with @type (@type)</xsl:message>
   ...
   <!--PATTERN tei_math-att.pointing-targetLang-constraint-targetLang-3-->
   ...
   <!--PATTERN tei_math-att.spanning-spanTo-constraint-spanTo-2-4-->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN tei_math-att.styleDef-schemeVersion-constraint-schemeVersionRequiresScheme-5-->
   ...
   <!--PATTERN tei_math-ptr-constraint-ptrAtts-6-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN tei_math-ref-constraint-refAtts-7-->
   ...
   <!--PATTERN tei_math-list-constraint-gloss-list-must-have-labels-8-->
   ...
   <!--PATTERN tei_math-biblStruct-constraint-deprecate-altIdentifier-child-9-->
   ...
   <!--PATTERN tei_math-relatedItem-constraint-targetorcontent1-10-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN tei_math-lg-constraint-atleast1oflggapl-11-->
   ...
   <!--PATTERN tei_math-quotation-constraint-quotationContents-12-->
