...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
                ...
                xmlns:eip-d2e28302="http://www.tei-c.org/ns/tite/1.0"
                xmlns:eip-d2e28317="http://www.tei-c.org/ns/tite/1.0"
                xmlns:eip-d2e28332="http://www.tei-c.org/ns/tite/1.0"
                xmlns:eip-d2e28347="http://www.tei-c.org/ns/tite/1.0"
                xmlns:eip-d2e28363="http://www.tei-c.org/ns/tite/1.0"
                xmlns:eip-d2e28378="http://www.tei-c.org/ns/tite/1.0"
                xmlns:eip-d2e28393="http://www.tei-c.org/ns/tite/1.0"
                xmlns:eip-d2e28413="http://www.tei-c.org/ns/tite/1.0"
                xmlns:eip-d2e28423="http://www.tei-c.org/ns/tite/1.0"
                xmlns:eip-d2e28433="http://www.tei-c.org/ns/tite/1.0"
   ...
   <!--PATTERN tei_tite-att.datable-calendar-constraint-calendar-1-->
...
belongs, but this <xsl:text/>
   ...
   <!--PATTERN tei_tite-att.typed-constraint-subtypeTyped-2-->


	  <!--RULE -->
   <xsl:template match="*[@subtype]" priority="1000" mode="M13">
 ...
 unless also categorized in general with @type (@type)</xsl:message>
   ...
   <!--PATTERN tei_tite-att.pointing-targetLang-constraint-targetLang-3-->
   ...
   <!--PATTERN tei_tite-ptr-constraint-ptrAtts-4-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN tei_tite-ref-constraint-refAtts-5-->
   ...
   <!--PATTERN tei_tite-list-constraint-gloss-list-must-have-labels-6-->
   ...
   <!--PATTERN tei_tite-lg-constraint-atleast1oflggapl-7-->


	  <!--RULE -->
   <xsl:template match="tei:lg" priority="1000" mode="M18">
