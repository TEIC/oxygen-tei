...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <!--PATTERN tei_speech-att.datable-calendar-constraint-calendar-1-->
...
belongs, but this <xsl:text/>
   ...
   <!--PATTERN tei_speech-att.typed-constraint-subtypeTyped-2-->
 ...
 unless also categorized in general with @type (@type)</xsl:message>
   ...
   <!--PATTERN tei_speech-att.pointing-targetLang-constraint-targetLang-3-->
   ...
   <!--PATTERN tei_speech-att.spanning-spanTo-constraint-spanTo-2-4-->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN tei_speech-att.styleDef-schemeVersion-constraint-schemeVersionRequiresScheme-5-->
   ...
   <!--PATTERN tei_speech-ptr-constraint-ptrAtts-6-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN tei_speech-ref-constraint-refAtts-7-->
   ...
   <!--PATTERN tei_speech-list-constraint-gloss-list-must-have-labels-8-->
   ...
   <!--PATTERN tei_speech-biblStruct-constraint-deprecate-altIdentifier-child-9-->
   ...
   <!--PATTERN tei_speech-relatedItem-constraint-targetorcontent1-10-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN tei_speech-lg-constraint-atleast1oflggapl-11-->
   ...
   <!--PATTERN tei_speech-quotation-constraint-quotationContents-12-->
...
On <xsl:text/>
   ...
   <!--PATTERN tei_speech-shift-constraint-shiftNew-15-->


	  <!--RULE -->
   <xsl:template match="tei:shift" priority="1000" mode="M18">
...
remarkable at this point. (@new / warning)</xsl:message>
   ...
   <!--PATTERN tei_speech-relation-constraint-reforkeyorname-16-->


	  <!--RULE -->
   <xsl:template match="tei:relation" priority="1000" mode="M19">
   ...
   <!--PATTERN tei_speech-relation-constraint-activemutual-17-->
...
@active and @mutual may be supplied (@active and @mutual)</xsl:message>
   ...
   <!--PATTERN tei_speech-relation-constraint-activepassive-18-->
   ...
   <!--PATTERN tei_speech-link-constraint-linkTargets3-19-->
   ...
   <!--PATTERN tei_speech-join-constraint-joinTargets3-20-->
...
You must supply at least two values for @target on <xsl:text/>
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:teiHeader" priority="1000" mode="M24">
