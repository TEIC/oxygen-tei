...
@spanTo on <xsl:text/>
   ...
   <!--PATTERN date-constraint-dates-->
	...
	<!--RULE -->
<xsl:template match="tei:date" priority="1000" mode="M9">
...
<xsl:choose>
   ...
   <!--PATTERN dimensions-constraint-duplicateDim-->
	...
	<!--RULE -->
<xsl:template match="tei:dimensions" priority="1000" mode="M14">
...
<xsl:choose>
   ...
   <!--PATTERN damageSpan-constraint-spanTo-->
	...
	<!--RULE -->
<xsl:template match="tei:damageSpan" priority="1000" mode="M19">
...
The @spanTo attribute of <xsl:text/>
   ...
   <!--PATTERN delSpan-constraint-spanTo-->
	...
	<!--RULE -->
<xsl:template match="tei:delSpan" priority="1000" mode="M20">
...
<xsl:choose>
   ...
   <!--PATTERN subst-constraint-substContents1-->
	...
	<!--RULE -->
<xsl:template match="tei:subst" priority="1000" mode="M21">
