...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <!--PATTERN tei_enrich-att.datable-calendar-constraint-calendar-1-->
...
belongs, but this <xsl:text/>
   ...
   <!--PATTERN tei_enrich-att.typed-constraint-subtypeTyped-2-->
 ...
 unless also categorized in general with @type (@type)</xsl:message>
   ...
   <!--PATTERN tei_enrich-att.pointing-targetLang-constraint-targetLang-3-->
   ...
   <!--PATTERN tei_enrich-att.spanning-spanTo-constraint-spanTo-2-4-->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN tei_enrich-att.styleDef-schemeVersion-constraint-schemeVersionRequiresScheme-5-->
   ...
   <!--PATTERN tei_enrich-date-constraint-dates-6-->


	  <!--RULE -->
   <xsl:template match="tei:date" priority="1000" mode="M11">
   ...
   <!--PATTERN tei_enrich-ptr-constraint-ptrAtts-7-->


	  <!--RULE -->
   <xsl:template match="tei:ptr" priority="1000" mode="M12">
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN tei_enrich-ref-constraint-refAtts-8-->


	  <!--RULE -->
   <xsl:template match="tei:ref" priority="1000" mode="M13">
   ...
   <!--PATTERN tei_enrich-list-constraint-gloss-list-must-have-labels-9-->
   ...
   <!--PATTERN tei_enrich-relatedItem-constraint-targetorcontent1-10-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN tei_enrich-lg-constraint-atleast1oflggapl-11-->
   ...
   <!--PATTERN tei_enrich-dimensions-constraint-duplicateDim-14-->


	  <!--RULE -->
   <xsl:template match="tei:dimensions" priority="1000" mode="M17">
...
The element <xsl:text/>
   ...
   <!--PATTERN tei_enrich-msIdentifier-constraint-msId_minimal-15-->


	  <!--RULE -->
   <xsl:template match="tei:msIdentifier" priority="1000" mode="M18">
   ...
   <!--PATTERN tei_enrich-msPart-constraint-deprecate-altIdentifier-child-16-->


	  <!--RULE -->
   <xsl:template match="tei:msPart" priority="1000" mode="M19">
   ...
   <!--PATTERN tei_enrich-relation-constraint-reforkeyorname-17-->


	  <!--RULE -->
   <xsl:template match="tei:relation" priority="1000" mode="M20">
   ...
   <!--PATTERN tei_enrich-relation-constraint-activemutual-18-->


	  <!--RULE -->
   <xsl:template match="tei:relation" priority="1000" mode="M21">
...
@active and @mutual may be supplied (@active and @mutual)</xsl:message>
   ...
   <!--PATTERN tei_enrich-relation-constraint-activepassive-19-->


	  <!--RULE -->
   <xsl:template match="tei:relation" priority="1000" mode="M22">
   ...
   <!--PATTERN tei_enrich-addSpan-constraint-spanTo-20-->


	  <!--RULE -->
   <xsl:template match="tei:addSpan" priority="1000" mode="M23">
   ...
   <!--PATTERN tei_enrich-damageSpan-constraint-spanTo-22-->


	  <!--RULE -->
   <xsl:template match="tei:damageSpan" priority="1000" mode="M24">
...
The @spanTo attribute of <xsl:text/>
   ...
   <!--PATTERN tei_enrich-delSpan-constraint-spanTo-24-->


	  <!--RULE -->
   <xsl:template match="tei:delSpan" priority="1000" mode="M25">
   ...
   <!--PATTERN tei_enrich-subst-constraint-substContents1-26-->


	  <!--RULE -->
   <xsl:template match="tei:subst" priority="1000" mode="M26">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:teiHeader" priority="1000" mode="M27">
