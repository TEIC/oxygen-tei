...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
                ...
                xmlns:eip-d2e51193="http://www.w3.org/2001/XInclude"
                xmlns:eip-d2e51263="http://www.w3.org/2001/XInclude"
   ...
   <!--PATTERN tei_xinclude-att.datable-calendar-constraint-calendar-1-->
...
belongs, but this <xsl:text/>
   ...
   <!--PATTERN tei_xinclude-att.typed-constraint-subtypeTyped-2-->
 ...
 unless also categorized in general with @type (@type)</xsl:message>
   ...
   <!--PATTERN tei_xinclude-att.pointing-targetLang-constraint-targetLang-3-->
   ...
   <!--PATTERN tei_xinclude-att.spanning-spanTo-constraint-spanTo-2-4-->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN tei_xinclude-att.styleDef-schemeVersion-constraint-schemeVersionRequiresScheme-5-->
   ...
   <!--PATTERN tei_xinclude-ptr-constraint-ptrAtts-6-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN tei_xinclude-ref-constraint-refAtts-7-->
   ...
   <!--PATTERN tei_xinclude-list-constraint-gloss-list-must-have-labels-8-->
   ...
   <!--PATTERN tei_xinclude-biblStruct-constraint-deprecate-altIdentifier-child-9-->


	  <!--RULE -->
   <xsl:template match="tei:biblStruct" priority="1000" mode="M15">
   ...
   <!--PATTERN tei_xinclude-relatedItem-constraint-targetorcontent1-10-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN tei_xinclude-lg-constraint-atleast1oflggapl-11-->
   ...
   <!--PATTERN tei_xinclude-quotation-constraint-quotationContents-12-->
...
On <xsl:text/>
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:teiHeader" priority="1000" mode="M19">
