...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <!--PATTERN tei_lite-att.datable-calendar-constraint-calendar-1-->
...
belongs, but this <xsl:text/>
   ...
   <!--PATTERN tei_lite-att.typed-constraint-subtypeTyped-2-->
 ...
 unless also categorized in general with @type (@type)</xsl:message>
   ...
   <!--PATTERN tei_lite-att.pointing-targetLang-constraint-targetLang-3-->
   ...
   <!--PATTERN tei_lite-att.spanning-spanTo-constraint-spanTo-2-4-->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN tei_lite-ptr-constraint-ptrAtts-5-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN tei_lite-ref-constraint-refAtts-6-->
   ...
   <!--PATTERN tei_lite-list-constraint-gloss-list-must-have-labels-7-->
   ...
   <!--PATTERN tei_lite-relatedItem-constraint-targetorcontent1-8-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN tei_lite-lg-constraint-atleast1oflggapl-9-->
   ...
   <!--PATTERN tei_lite-s-constraint-noNestedS-12-->
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:teiHeader" priority="1000" mode="M16">
