...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <!--PATTERN tei_corpus-att.datable-calendar-constraint-calendar-1-->
...
belongs, but this <xsl:text/>
   ...
   <!--PATTERN tei_corpus-att.typed-constraint-subtypeTyped-2-->
 ...
 unless also categorized in general with @type (@type)</xsl:message>
   ...
   <!--PATTERN tei_corpus-att.pointing-targetLang-constraint-targetLang-3-->
   ...
   <!--PATTERN tei_corpus-att.spanning-spanTo-constraint-spanTo-2-4-->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN tei_corpus-att.styleDef-schemeVersion-constraint-schemeVersionRequiresScheme-5-->
   ...
   <!--PATTERN tei_corpus-ptr-constraint-ptrAtts-6-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN tei_corpus-ref-constraint-refAtts-7-->
   ...
   <!--PATTERN tei_corpus-list-constraint-gloss-list-must-have-labels-8-->
   ...
   <!--PATTERN tei_corpus-biblStruct-constraint-deprecate-altIdentifier-child-9-->
   ...
   <!--PATTERN tei_corpus-relatedItem-constraint-targetorcontent1-10-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN tei_corpus-lg-constraint-atleast1oflggapl-11-->
   ...
   <!--PATTERN tei_corpus-quotation-constraint-quotationContents-12-->
...
On <xsl:text/>
   ...
   <!--PATTERN tei_corpus-relation-constraint-reforkeyorname-15-->
   ...
   <!--PATTERN tei_corpus-relation-constraint-activemutual-16-->
...
@active and @mutual may be supplied (@active and @mutual)</xsl:message>
   ...
   <!--PATTERN tei_corpus-relation-constraint-activepassive-17-->
   ...
   <!--PATTERN tei_corpus-link-constraint-linkTargets3-18-->


	  <!--RULE -->
   <xsl:template match="tei:link" priority="1000" mode="M21">
   ...
   <!--PATTERN tei_corpus-join-constraint-joinTargets3-19-->
...
You must supply at least two values for @target on <xsl:text/>
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:teiHeader" priority="1000" mode="M23">
