...
<xsl:if test="//*[ not( generate-id(.) eq generate-id(      current() ) ) ]/@prefix = @prefix">
   ...
   <!--PATTERN constraintSpec-constraint-sch-->
	...
	<!--RULE -->
<xsl:template match="tei:constraintSpec" priority="1000" mode="M35">
...
<xsl:if test="tei:constraint/sch:* and    not(@scheme='isoschematron')">
   ...
   <!--PATTERN attDef-constraint-attDefContents-->
	...
	<!--RULE -->
<xsl:template match="tei:attDef" priority="1000" mode="M37">
...
should correspond to an existing module, via a moduleSpec or
   ...
   <!--PATTERN att.deprecated-constraint-deprecated-->
	...
	<!--RULE -->
<xsl:template match="tei:*[@validUntil]" priority="1001" mode="M39">
...
<xsl:if test="@validUntil cast as xs:date eq current-date()">
   ...
   <!--PATTERN rdgGrp-constraint-only1lem-->
	...
	<!--RULE -->
<xsl:template match="tei:rdgGrp" priority="1000" mode="M40">
...
<xsl:choose>
   ...
   <!--PATTERN variantEncoding-constraint-variantEncodingLocation-->
	...
	<!--RULE -->
<xsl:template match="tei:variantEncoding" priority="1000" mode="M41">
