...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <!--PATTERN tei_allPlus-att.datable-calendar-constraint-calendar-1-->
...
belongs, but this <xsl:text/>
   ...
   <!--PATTERN tei_allPlus-att.typed-constraint-subtypeTyped-2-->
 ...
 unless also categorized in general with @type (@type)</xsl:message>
   ...
   <!--PATTERN tei_allPlus-att.pointing-targetLang-constraint-targetLang-3-->
   ...
   <!--PATTERN tei_allPlus-att.spanning-spanTo-constraint-spanTo-2-4-->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN tei_allPlus-att.styleDef-schemeVersion-constraint-schemeVersionRequiresScheme-5-->
   ...
   <!--PATTERN tei_allPlus-ptr-constraint-ptrAtts-6-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN tei_allPlus-ref-constraint-refAtts-7-->
   ...
   <!--PATTERN tei_allPlus-list-constraint-gloss-list-must-have-labels-8-->
   ...
   <!--PATTERN tei_allPlus-biblStruct-constraint-deprecate-altIdentifier-child-9-->
   ...
   <!--PATTERN tei_allPlus-relatedItem-constraint-targetorcontent1-10-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN tei_allPlus-lg-constraint-atleast1oflggapl-11-->
   ...
   <!--PATTERN tei_allPlus-s-constraint-noNestedS-12-->
   ...
   <!--PATTERN tei_allPlus-span-constraint-targetfrom-13-->
...
Only one of the attributes @target and @from may be supplied on <xsl:text/>
   ...
   <!--PATTERN tei_allPlus-span-constraint-targetto-14-->
...
Only one of the attributes @target and @to may be supplied on <xsl:text/>
   ...
   <!--PATTERN tei_allPlus-span-constraint-tonotfrom-15-->
...
If @to is supplied on <xsl:text/>
   ...
   <!--PATTERN tei_allPlus-span-constraint-tofrom-16-->
...
The attributes @to and @from on <xsl:text/>
   ...
   <!--PATTERN tei_allPlus-quotation-constraint-quotationContents-17-->
...
On <xsl:text/>
   ...
   <!--PATTERN tei_allPlus-f-constraint-fValConstraints-18-->
   ...
   <!--PATTERN tei_allPlus-link-constraint-linkTargets3-19-->
   ...
   <!--PATTERN tei_allPlus-join-constraint-joinTargets3-20-->
...
You must supply at least two values for @target on <xsl:text/>
   ...
   <!--PATTERN tei_allPlus-dimensions-constraint-duplicateDim-21-->
...
The element <xsl:text/>
   ...
   <!--PATTERN tei_allPlus-msIdentifier-constraint-msId_minimal-22-->
   ...
   <!--PATTERN tei_allPlus-msPart-constraint-deprecate-altIdentifier-child-23-->
   ...
   <!--PATTERN tei_allPlus-relation-constraint-reforkeyorname-24-->
   ...
   <!--PATTERN tei_allPlus-relation-constraint-activemutual-25-->
...
@active and @mutual may be supplied (@active and @mutual)</xsl:message>
   ...
   <!--PATTERN tei_allPlus-relation-constraint-activepassive-26-->
   ...
   <!--PATTERN tei_allPlus-shift-constraint-shiftNew-27-->
...
remarkable at this point. (@new / warning)</xsl:message>
   ...
   <!--PATTERN tei_allPlus-att.identified-constraint-spec-in-module-28-->
...
should correspond to an existing module, via a moduleSpec or
   ...
   <!--PATTERN tei_allPlus-att.deprecated-validUntil-constraint-deprecated-29-->
   ...
   <!--PATTERN tei_allPlus-moduleRef-constraint-modref-30-->


	  <!--RULE -->
   <xsl:template match="tei:moduleRef" priority="1000" mode="M40">
...
Child elements of <xsl:text/>
   ...
   <!--PATTERN tei_allPlus-moduleRef-prefix-constraint-not-same-prefix-31-->
   ...
   <!--PATTERN tei_allPlus-sequence-constraint-sequencechilden-32-->


	  <!--RULE -->
   <xsl:template match="tei:sequence" priority="1000" mode="M42">
   ...
   <!--PATTERN tei_allPlus-alternate-constraint-alternatechilden-33-->


	  <!--RULE -->
   <xsl:template match="tei:alternate" priority="1000" mode="M43">
   ...
   <!--PATTERN tei_allPlus-constraintSpec-constraint-sch-34-->


	  <!--RULE -->
   <xsl:template match="tei:constraintSpec" priority="1000" mode="M44">
   ...
   <!--PATTERN tei_allPlus-constraintSpec-constraint-isosch-35-->


	  <!--RULE -->
   <xsl:template match="tei:constraintSpec" priority="1000" mode="M45">
   ...
   <!--PATTERN tei_allPlus-constraintSpec-constraint-needrules-36-->
   ...
   <!--PATTERN tei_allPlus-attDef-constraint-attDefContents-37-->


	  <!--RULE -->
   <xsl:template match="tei:attDef" priority="1000" mode="M47">
   ...
   <!--PATTERN tei_allPlus-attDef-constraint-noDefault4Required-38-->


	  <!--RULE -->
   <xsl:template match="tei:attDef[@usage eq 'req']" priority="1000" mode="M48">
   ...
   <!--PATTERN tei_allPlus-attDef-constraint-defaultIsInClosedList-twoOrMore-39-->
   ...
   <!--PATTERN tei_allPlus-attDef-constraint-defaultIsInClosedList-one-40-->
   ...
   <!--PATTERN tei_allPlus-rdgGrp-constraint-only1lem-41-->


	  <!--RULE -->
   <xsl:template match="tei:rdgGrp" priority="1000" mode="M51">
   ...
   <!--PATTERN tei_allPlus-variantEncoding-location-constraint-variantEncodingLocation-42-->


	  <!--RULE -->
   <xsl:template match="tei:variantEncoding" priority="1000" mode="M52">
   ...
   <!--PATTERN tei_allPlus-addSpan-constraint-spanTo-45-->
   ...
   <!--PATTERN tei_allPlus-damageSpan-constraint-spanTo-47-->


	  <!--RULE -->
   <xsl:template match="tei:damageSpan" priority="1000" mode="M54">
...
The @spanTo attribute of <xsl:text/>
   ...
   <!--PATTERN tei_allPlus-delSpan-constraint-spanTo-49-->


	  <!--RULE -->
   <xsl:template match="tei:delSpan" priority="1000" mode="M55">
   ...
   <!--PATTERN tei_allPlus-subst-constraint-substContents1-51-->


	  <!--RULE -->
   <xsl:template match="tei:subst" priority="1000" mode="M56">
