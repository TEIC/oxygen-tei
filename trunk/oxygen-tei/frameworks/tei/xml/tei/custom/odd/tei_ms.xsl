...
<!--PATTERN att.datable-constraint-calendar-->
	...
	<!--RULE -->
<xsl:template match="tei:*[@calendar]" priority="1000" mode="M4">
...
@spanTo on <xsl:text/>
   ...
   <!--PATTERN ptr-constraint-ptrAtts-->
	...
	<!--RULE -->
<xsl:template match="tei:ptr" priority="1000" mode="M9">
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN ref-constraint-refAtts-->
	...
	<!--RULE -->
<xsl:template match="tei:ref" priority="1000" mode="M10">
...
<xsl:choose>
   ...
   <!--PATTERN lg-constraint-atleast1oflggapl-->
	...
	<!--RULE -->
<xsl:template match="tei:lg" priority="1000" mode="M12">
...
<xsl:if test="@passive and not(@active)">
   ...
   <!--PATTERN addSpan-constraint-spanTo-->
	...
	<!--RULE -->
<xsl:template match="tei:addSpan" priority="1000" mode="M24">
...
<xsl:choose>
   ...
   <!--PATTERN damageSpan-constraint-spanTo-->
	...
	<!--RULE -->
<xsl:template match="tei:damageSpan" priority="1000" mode="M25">
...
The @spanTo attribute of <xsl:text/>
   ...
   <!--PATTERN delSpan-constraint-spanTo-->
	...
	<!--RULE -->
<xsl:template match="tei:delSpan" priority="1000" mode="M26">
...
The element <xsl:text/>
   ...
   <!--PATTERN msIdentifier-constraint-msId_minimal-->
	...
	<!--RULE -->
<xsl:template match="tei:msIdentifier" priority="1000" mode="M29">
