...
<!--PATTERN att.pointing-constraint-targetLang-->
	...
	<!--RULE -->
<xsl:template match="tei:*[@targetLang]" priority="1000" mode="M2">
...
<xsl:if test="@target and @cRef">
   ...
   <!--PATTERN ref-constraint-refAtts-->
	...
	<!--RULE -->
<xsl:template match="tei:ref" priority="1000" mode="M4">
...
<xsl:if test="@target and @cRef">
   ...
   <!--PATTERN lg-constraint-atleast1oflggapl-->
	...
	<!--RULE -->
<xsl:template match="tei:lg" priority="1000" mode="M5">
