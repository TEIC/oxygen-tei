...
<xsl:choose>
   ...
   <!--PATTERN relation-constraint-activemutual-->
	...
	<!--RULE -->
<xsl:template match="tei:relation" priority="1000" mode="M8">
...
<xsl:if test="@active and @mutual">
   ...
   <!--PATTERN relation-constraint-activepassive-->
	...
	<!--RULE -->
<xsl:template match="tei:relation" priority="1000" mode="M9">
...
<xsl:if test="@target and @targets">
   ...
   <!--PATTERN link-constraint-linkTargets2-->
	...
	<!--RULE -->
<xsl:template match="tei:link" priority="1000" mode="M11">
...
<xsl:if test="@target and @targets">
   ...
   <!--PATTERN join-constraint-joinTargets2-->
	...
	<!--RULE -->
<xsl:template match="tei:join" priority="1000" mode="M14">
...
<xsl:if test="@target and @targets">
   ...
   <!--PATTERN alt-constraint-altTargets2-->
	...
	<!--RULE -->
<xsl:template match="tei:alt" priority="1000" mode="M17">
