...
<xsl:choose>
   ...
   <!--PATTERN s-constraint-noNestedS-->
	...
	<!--RULE -->
<xsl:template match="tei:s" priority="1000" mode="M14">
...
<xsl:if test="tei:s">
   ...
   <!--PATTERN span-constraint-targetfrom-->
	...
	<!--RULE -->
<xsl:template match="tei:span" priority="1000" mode="M15">
...
The attributes @to and @from on <xsl:text/>
   ...
   <!--PATTERN quotation-constraint-quotationContents-->
	...
	<!--RULE -->
<xsl:template match="tei:quotation" priority="1000" mode="M19">
...
On <xsl:text/>
   ...
   <!--PATTERN f-constraint-fValConstraints-->
	...
	<!--RULE -->
<xsl:template match="tei:fVal" priority="1001" mode="M20">
...
<xsl:choose>
    ...
    contain both text and element content (not(tei:* and text))</xsl:message>
	  ...
	  <!--RULE -->
<xsl:template match="tei:fVal" priority="1000" mode="M20">
...
<xsl:choose>
   ...
   <!--PATTERN join-constraint-joinTargets1-->
	...
	<!--RULE -->
<xsl:template match="tei:join" priority="1000" mode="M24">
...
You must supply at least two values for @target on <xsl:text/>
   ...
   <!--PATTERN alt-constraint-altTargets1-->
	...
	<!--RULE -->
<xsl:template match="tei:alt" priority="1000" mode="M27">
...
<xsl:if test="not(@target) and not(@targets)">
   ...
   <!--PATTERN dimensions-constraint-duplicateDim-->
	...
	<!--RULE -->
<xsl:template match="tei:dimensions" priority="1000" mode="M29">
...
<xsl:if test="@passive and not(@active)">
   ...
   <!--PATTERN rdgGrp-constraint-only1lem-->


	<!--RULE -->
<xsl:template match="tei:rdgGrp" priority="1000" mode="M33">
...
<xsl:choose>
   ...
   <!--PATTERN variantEncoding-constraint-variantEncodingLocation-->


	<!--RULE -->
<xsl:template match="tei:variantEncoding" priority="1000" mode="M34">
...
<xsl:choose>
   ...
   <!--PATTERN addSpan-constraint-spanTo-->
	...
	<!--RULE -->
<xsl:template match="tei:addSpan" priority="1000" mode="M35">
...
<xsl:choose>
   ...
   <!--PATTERN damageSpan-constraint-spanTo-->
	...
	<!--RULE -->
<xsl:template match="tei:damageSpan" priority="1000" mode="M36">
...
The @spanTo attribute of <xsl:text/>
   ...
   <!--PATTERN delSpan-constraint-spanTo-->
	...
	<!--RULE -->
<xsl:template match="tei:delSpan" priority="1000" mode="M37">
...
<xsl:choose>
   ...
   <!--PATTERN moduleRef-constraint-modref-->
	...
	<!--RULE -->
<xsl:template match="tei:moduleRef" priority="1000" mode="M39">
...
should correspond to an existing module, via a moduleSpec or
   ...
   <!--PATTERN att.deprecated-constraint-deprecated-->
	...
	<!--RULE -->
<xsl:template match="tei:*[@validUntil]" priority="1001" mode="M45">
