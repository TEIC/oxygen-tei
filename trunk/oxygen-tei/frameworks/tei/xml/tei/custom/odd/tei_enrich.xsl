...
<xsl:choose>
   ...
   <!--PATTERN date-constraint-dates-->


	<!--RULE -->
<xsl:template match="tei:date" priority="1000" mode="M4">
...
<xsl:choose>
   ...
   <!--PATTERN ptr-constraint-ptrAtts-->
	...
	<!--RULE -->
<xsl:template match="tei:ptr" priority="1000" mode="M5">
...
<xsl:if test="@target and @cRef">
   ...
   <!--PATTERN ref-constraint-refAtts-->
	...
	<!--RULE -->
<xsl:template match="tei:ref" priority="1000" mode="M6">
...
<xsl:if test="@target and @cRef">
   ...
   <!--PATTERN relatedItem-constraint-targetorcontent1-->
	...
	<!--RULE -->
<xsl:template match="tei:relatedItem" priority="1000" mode="M7">
...
<xsl:choose>
   ...
   <!--PATTERN lg-constraint-atleast1oflggapl-->
	...
	<!--RULE -->
<xsl:template match="tei:lg" priority="1000" mode="M8">
...
<xsl:choose>
   ...
   <!--PATTERN dimensions-constraint-duplicateDim-->
	...
	<!--RULE -->
<xsl:template match="tei:dimensions" priority="1000" mode="M9">
...
<xsl:if test="count(tei:depth)&gt; 1">
   ...
   <!--PATTERN msIdentifier-constraint-msId_minimal-->
	...
	<!--RULE -->
<xsl:template match="tei:msIdentifier" priority="1000" mode="M10">
...
<xsl:if test="local-name(*[1])='idno' or                              local-name(*[1])='altIdentifier' or        .='' ">
   ...
   <!--PATTERN relation-constraint-activemutual-->
	...
	<!--RULE -->
<xsl:template match="tei:relation" priority="1000" mode="M11">
...
<xsl:if test="@active and @mutual">
   ...
   <!--PATTERN relation-constraint-activepassive-->
	...
	<!--RULE -->
<xsl:template match="tei:relation" priority="1000" mode="M12">
...
<xsl:if test="@passive and not(@active)">
   ...
   <!--PATTERN addSpan-constraint-spanTo-->
	...
	<!--RULE -->
<xsl:template match="tei:addSpan" priority="1000" mode="M13">
...
<xsl:choose>
   ...
   <!--PATTERN delSpan-constraint-spanTo-->
	...
	<!--RULE -->
<xsl:template match="tei:delSpan" priority="1000" mode="M15">
...
<xsl:choose>
   ...
   <!--PATTERN subst-constraint-substContents1-->
	...
	<!--RULE -->
<xsl:template match="tei:subst" priority="1000" mode="M16">
