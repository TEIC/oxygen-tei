...
<xsl:choose>
   ...
   <!--PATTERN date-constraint-dates-->
	...
	<!--RULE -->
<xsl:template match="tei:date" priority="1000" mode="M8">
...
<xsl:choose>
   ...
   <!--PATTERN dimensions-constraint-duplicateDim-->
	...
	<!--RULE -->
<xsl:template match="tei:dimensions" priority="1000" mode="M13">
...
<xsl:if test="not(parent::tei:msPart) and       (local-name(*[1])='idno' or       local-name(*[1])='altIdentifier' or       normalize-space(.)='')">
   ...
   <!--PATTERN relation-constraint-activemutual-->
	...
	<!--RULE -->
<xsl:template match="tei:relation" priority="1000" mode="M15">
...
@active and @mutual may be supplied (@active and @mutual)</xsl:message>
   ...
   <!--PATTERN relation-constraint-activepassive-->
	...
	<!--RULE -->
<xsl:template match="tei:relation" priority="1000" mode="M16">
...
<xsl:choose>
   ...
   <!--PATTERN damageSpan-constraint-spanTo-->
	...
	<!--RULE -->
<xsl:template match="tei:damageSpan" priority="1000" mode="M18">
...
The @spanTo attribute of <xsl:text/>
   ...
   <!--PATTERN delSpan-constraint-spanTo-->
	...
	<!--RULE -->
<xsl:template match="tei:delSpan" priority="1000" mode="M19">
